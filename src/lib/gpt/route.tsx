					...
					messages: [
						...
						},
						{
							...
							content: [
								...
								input.generationMode === "secret"
									? "- そのミッションで割り当てられた一人がこっそり実行できる内容にし、他メンバーに気づかれるか気づかれないかの絶妙なラインのものにしてください。"
								...
								input.generationMode === "secret"
									? "- 極秘ミッションは、対象ユーザー本人だけが知る個別ミッションとして生成する。旅行終了後、他のメンバーが内容を推理し、当てられなかったミッションには本人にポイントを与える。"
									: "",
								input.generationMode === "secret"
									? "- 極秘ミッションは、何らかの行動を伴うようにし、バレなければ他のメンバーが驚くような内容のものにしてください"
									: "",
								input.generationMode === "secret"
									? "- points は 30,40,50 のいずれかで、極秘ミッションはバレやすければ高ポイントにする傾向で出力してください。"
